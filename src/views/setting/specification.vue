    ...
    <div class="admin_main_block">
      <div class="admin_main_block_top">
        <div class="admin_main_block_left">
          <div>
            {{ $t('config.agreement.specification') }}
          </div>
        </div>
      </div>
      ...
      <div class="admin_form_main">
        <el-form label-width="120px" ref="dataForm" :model="dataForm" :rules="dataRule">
          ...
          <el-form-item>
            <el-button v-if="isAuth('setting:specification')" type="primary" @click="dataFormSubmit()">
              {{ $t('common.confirm') }}
            </el-button>
          </el-form-item>
        </el-form>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      {
        this.$http({
          url: this.$http.adornUrl(`/setting/specification`),
          method: 'get',
